...
public class ThemLaoDong extends JFrame implements ActionListener, MouseListener{
	private JTextField txtMaNV;
	private JTextField txtTenNV;
	private JDateChooser date_ngaySinh;
	private JComponent rdPhaiNam;
	...
	public ThemLaoDong() throws Exception {
		...
		rdPhaiNam = new JRadioButton("Nam",true);
		...
		btnThem.setBounds(82, 24, 133, 40);
		panel_2.add(btnThem);
	...
	public static void main(String[] args) throws Exception {
		new ThemLaoDong().setVisible(true);
	}
	@Override
	...
	private void updateComboBox() {
		...
		for (PhongBan pb : dsPB) {
			cbPhongBan.addItem(pb.getMaPhongBan());
		}
	}
	@Override
